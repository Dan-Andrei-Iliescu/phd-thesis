...
\title{Learning Instrumental Variables for Big Data}
...
This  
1. An instrumental variable has to be identified by the designer of the experiment. The model itself cannot choose an instrumental variable.
